...
var a = t("Appcfg"),
  ...
  return t.getInstance = function () {
    ...
    var t = this;
    r.ResourceMgr.getInstance().loadRes("configs", "GameJsonCfg", cc.JsonAsset, function (e) {
      t.data = e.json, e.decRef(), i.EventMgr.getInstance().emit(a.BaseEventName.Loading, a.LoadingProcess.ExcelCfg);
    });
  }, t.prototype.reloadConfig = function (t, e) {
    var o = this;

    if ("A" != t && "C" != t) {
      if (this.bSheetNames.length <= 0) e && e();else {
        var a = "configsB";
        "B" == t ? a = "configsB" : "D" == t && (a = "configsD"), r.ResourceMgr.getInstance().loadRes(a, "GameJsonCfg", cc.JsonAsset, function (t) {
          for (var a = t.json, i = 0; i < o.bSheetNames.length; i++) {
    ...
    return this.data.RoleBasePropCfg || console.log("请配置玩家属性表！！！"), this.data.RoleBasePropCfg[0];
  }, t.prototype.getAllGoodsCfg = function () {
    return this.data.GoodsCfg || console.log("请配置物品表！！！"), this.data.GoodsCfg;
  }, t.prototype.getGoodsCfg = function (t) {
    var e = this.getAllGoodsCfg();
    return e[t - 1] || console.log("第" + t + "个物品不存在！！！"), e[t - 1];
  }, t.prototype.getAllSecCfg = function () {
    return this.data.SecCfg || console.log("请配置章节表！！！"), this.data.SecCfg;
    ...
    return this.data.MonsterProCfg || console.log("当前怪物表不存在！！！"), this.data.MonsterProCfg;
    ...
    return this.data.SkillBookCfg || console.log("技能书列表不存在！！！"), this.data.SkillBookCfg;
    ...
    return this.data.SkillQualityCfg || console.log("技能品质列表不存在！！！"), this.data.SkillQualityCfg;
  }, t.prototype.getSkillQuality = function (t) {
    var e = this.getSkillQualityCfg();
    return e[t - 1] ? e[t - 1] : e[0];
  }, t.prototype.getFetterCfg = function () {
    return this.data.FetterCfg || console.log("羁绊列表不存在！！！"), this.data.FetterCfg;
  }, t.prototype.getFetter = function (t) {
    var e = this.getFetterCfg();
    return e[t - 1] ? e[t - 1] : e[0];
  }, t.prototype.getSkillBookProbCfg = function () {
    return this.data.SkillBookProbCfg || console.log("技能书概率列表不存在！！！"), this.data.SkillBookProbCfg;
  }, t.prototype.getSkillBookProb = function (t) {
    var e = this.getSkillBookProbCfg();
    return e[t - 1] ? e[t - 1] : e[0];
  }, t.prototype.getAllSkillBookLevelCfg = function () {
    return this.data.SkillBookLevelCfg || console.log("技能书升级列表不存在！！！"), this.data.SkillBookLevelCfg;
    ...
    return this.data.SkillCfg || console.log("技能列表不存在！！！"), this.data.SkillCfg;
    ...
    switch (t) {
      case 1:
        this.data.SecFactorCfg || console.log("普通怪系数列表不存在！！！"), e = this.data.SecFactorCfg;
        break;

      case 2:
        this.data.EliteFactorCfg || console.log("精英怪系数列表不存在！！！"), e = this.data.EliteFactorCfg;
        break;

      case 3:
        this.data.BossFactorCfg || console.log("Boss系数列表不存在！！！"), e = this.data.BossFactorCfg;
        break;
    ...
    return this.data.EquipCfg || console.log("请配置装备表"), this.data.EquipCfg;
    ...
    return this.data.EquipStrengthenCfg || console.log("请配置装备强化表"), this.data.EquipStrengthenCfg;
    ...
    return this.data.EquipStarCfg || console.log("请配置装备升星表"), this.data.EquipStarCfg;
    ...
    return this.data.EquipSuitCfg || console.log("请配置装备套装表"), this.data.EquipSuitCfg;
    ...
    return this.data.DrawCardCfg || console.log("请配置商品表"), this.data.DrawCardCfg;
    ...
    return this.data.DrawCardLibraryCfg || console.log("请配置奖励池表"), this.data.DrawCardLibraryCfg;
    ...
    return this.data.ResourceAcquisitionCfg || console.log("请配置资源获取表"), this.data.ResourceAcquisitionCfg;
  }, t.prototype.getGoodsCountForTypeAndSec = function (t, e) {
    for (var o = this.getResourceAcquisitionCfg(), a = 0; a < o.length; a++) {
      if (t == o[a].Type && e == o[a].Parameter) return o[a].GetNum;
    }

    return console.log("没有当前配置"), 100;
  }, t.prototype.getGoodsCountForType = function (t) {
    for (var e = this.getResourceAcquisitionCfg(), o = 0; o < e.length; o++) {
      if (t == e[o].Type) return e[o].GetNum;
    }

    return console.log("没有当前配置"), 100;
  }, t.prototype.getSalutationCfg = function () {
    return this.data.TitleCfg || console.log("请配置称号表"), this.data.TitleCfg;
    ...
    return this.data.TaskCfg || console.log("请配置任务表"), this.data.TaskCfg;
  }, t.prototype.getTaskCfgForId = function (t, e) {
    for (var o = this.getTaskCfg(), a = 0; a < o.length; a++) {
      if (o[a].ID == t && o[a].Type == e) return o[a];
    }

    return null;
  }, t.prototype.getParamsCfg = function () {
    return this.data.ParamsCfg || console.log("请配置基础参数表"), this.data.ParamsCfg;
  }, t.prototype.getParamsCfgForSingle = function (t) {
    return this.data.ParamsCfg[t - 1] || console.log("参数" + t + "不存在！！！"), this.data.ParamsCfg[t - 1];
  }, t.prototype.getAllPetsCfg = function () {
    return this.data.PetsCfg || console.log("请配置宠物表"), this.data.PetsCfg;
    ...
    return this.data.EffectCfg || console.log("请配置特效表"), this.data.EffectCfg;
    ...
    return this.data.MysteriousShop || console.log("请配置神秘商店表"), this.data.MysteriousShop;
    ...
    return this.data.MainTaskCfg || console.error("请配置TitleCfg表"), this.data.MainTaskCfg;
