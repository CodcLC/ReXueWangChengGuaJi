...
m = function(t) {
    ...
    e.prototype.start = function() {
        ...
        s.SdkMgr.getInstance().showBanner(),
        this.initData(),
        this.initView()
    },
    ...
    e.prototype.initTaskListView = function() {
        for (var t = this,
        e = u.PlayerMgr.getInstance().geUserData().getCurTaskList(), o = [], a = 0; a < e.length; a++) o.push(e[a]);
        var i = l.DataMgr.getInstance().getTaskCfg(),
        r = [];
        for (a = 0; a < i.length; a++) o[i[a].Type - 1].id == i[a].ID && r.push(i[a]);
        o.sort(function(t, e) {
            return e.state - t.state
        });
        var n = function(e) {
            for (var a = function(a) {
                o[e].id == r[a].ID && s.scheduleOnce(function() {
                    var i = cc.instantiate(t.NodeTask);
                    i.active = !0,
                    i.parent = t.contentTask,
                    i.setPosition(cc.v2( - 650, 0)),
                    t.loadTaskItem(i, r[a], o[e]);
                    var n = i.getChildByName("LayoutDec");
                    t.enterAnimForTask(i,
                    function() {
        ...
        s = this;
        for (a = 0; a < o.length; a++) n(a)
    },
    e.prototype.playEnterAnim = function() {
        for (var t = this,
        e = function(e) {
            o.scheduleOnce(function() {
                var o = t.contentTask.children[e],
                a = o.getChildByName("LayoutDec");
                t.enterAnimForTask(o,
                function() {
                    cc.isValid(a) && (a.active = !0, c.TweenMgr.getInstance().stampAni(a))
                }),
                e == t.contentTask.childrenCount - 1 && (t.contentTask.getComponent(cc.Layout).updateLayout(), t.scrollViewEvent_Task())
            },
            .1 * e)
        },
        o = this, a = 0; a < this.contentTask.childrenCount; a++) e(a)
    },
    e.prototype.loadTaskItem = function(t, e, o) {
        t.zIndex = -o.state,
        t.getComponent(g.default).initData(e, o),
        t.getComponent(cc.Sprite).spriteFrame = 1 == o.state ? this.SpCanGet: this.SpNotGet;
        var a = l.DataMgr.getInstance().getGoodsCfg(e.RewardType);
        t.getChildByName("SpIconBg").getComponent(cc.Sprite).spriteFrame = this.SpBgIconArr[a.goodsQualityId - 1],
        t.getChildByName("SpIcon").getComponent(cc.Sprite).spriteFrame = this.SpIconArr[a.id - 1],
        t.getChildByName("LabRewardNum").getComponent(cc.Label).string = "x" + e.RewardNum;
        ...
        switch (t.getChildByName("SpBar").getComponent(cc.Sprite).fillRange = n / e.TaskParameter, t.getChildByName("LabTaskNum").getComponent(cc.Label).string = n + "/" + e.TaskParameter, o.state) {
            ...
            break;
            case - 1 : this.taskState(t, !1, !1, !0);
        }
    },
    e.prototype.taskState = function(t, e, o, a) {
        t.getChildByName("BtnNotGet").active = e,
        t.getChildByName("BtnGet").active = o,
        t.getChildByName("SpCompleted").active = a
    },
    ...
    e.prototype.closeView = function() {
        s.SdkMgr.getInstance().hideBanner(),
        this.closeUI(),
        s.SdkMgr.getInstance().showInsert(s.AdType.FreeLotty)
    },
    r([f(cc.Label)], e.prototype, "LabTitle", void 0),
    r([f(cc.SpriteFrame)], e.prototype, "SpNotGet", void 0),
    r([f(cc.SpriteFrame)], e.prototype, "SpCanGet", void 0),
    r([f(cc.SpriteFrame)], e.prototype, "SpBgIconArr", void 0),
    r([f(cc.SpriteFrame)], e.prototype, "SpIconArr", void 0),
    r([f({
        type: cc.Node,
        tooltip: "任务节点"
    })], e.prototype, "NodeTask", void 0),
    r([f(cc.Node)], e.prototype, "BtnBack", void 0),
    r([f(cc.Node)], e.prototype, "contentTask", void 0),
    r([h], e)
} (n.default);
o.default = m