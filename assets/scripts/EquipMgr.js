...
g = function() {
    ...
    t.prototype.getAllSuitList = function() {
        ...
        for (a = 0; a < r.length; a++) for (var n = c.DataMgr.getInstance().getEquipCfg(r[a].id), s = 0; s < e.length; s++) if (n.suitId == e[s].id) {
            e[s].count++;
            break
        }
        return e
    ...
    t.prototype.getWearEquipData = function(t) {
        for (var e = u.PlayerMgr.getInstance().geUserData().getWearEquipList(), o = 0; o < e.length; o++) if (e[o].type == t) return e[o];
        return null
    },
    t.prototype.getOwnedEquipList = function(t) {
        void 0 === t && (t = 1);
        for (var e = [], o = u.PlayerMgr.getInstance().geUserData().getOwnedEquipList(), a = 0; a < o.length; a++) o[a].sort(function(t, e) {
            return e.id - t.id
        }),
        o[a].sort(function(t, e) {
            return e.quality - t.quality
        });
        for (a = 0; a < o.length; a++) for (var i = 0; i < o[a].length; i++) e.push(o[a][i]);
    ...
    t.prototype.getOwmedEquipForEquipType = function(t) {
        var e = t - 1;
        return (e < 0 || e > 5) && (e = 0),
        u.PlayerMgr.getInstance().geUserData().getOwnedEquipList()[e]
    },
    ...
    t.prototype.getOwnedEquipCount = function() {
        for (var t = 0,
        e = u.PlayerMgr.getInstance().geUserData().getOwnedEquipList(), o = 0; o < e.length; o++) t += e[o].length;
        return t
    },
    ...
    t.prototype.replaceEquip = function(t, e, o) {
        if (e && o) {
            u.PlayerMgr.getInstance().geUserData().replaceEquip(e, o),
            u.PlayerMgr.getInstance().geUserData().refreshWearEquipQuality(o.type, o.quality),
            p.default.getInstance().getPropForAllEquip(!0),
            a.EventMgr.getInstance().emit(s.EventName.ReplaceEquip, t, e, o);
            var i = c.DataMgr.getInstance().getEquipCfg(o.id);
            console.log("当前装备id：", o.id),
            1 == i.isSkin ? n.default.instance.rolePlay(o.id) : 4 == i.equipType && n.default.instance.rolePlay_reset(o.id)
        }
    },
    t.prototype.wearEquip = function(t, e) {
        if (e) {
            u.PlayerMgr.getInstance().geUserData().wearEquip(e),
            u.PlayerMgr.getInstance().geUserData().refreshWearEquipQuality(e.type, e.quality),
            p.default.getInstance().getPropForAllEquip(!0),
            a.EventMgr.getInstance().emit(s.EventName.WearEquip, t, e);
            var o = c.DataMgr.getInstance().getEquipCfg(e.id);
            console.log("当前装备id：", e.id),
            1 == o.isSkin && n.default.instance.rolePlay(e.id)
        }
    },
    t.prototype.unloadEquip = function(t) {
        if (t) {
            u.PlayerMgr.getInstance().geUserData().unloadEquip(t),
            p.default.getInstance().getPropForAllEquip(!0),
            a.EventMgr.getInstance().emit(s.EventName.UnloadEquip, t);
            var e = c.DataMgr.getInstance().getEquipCfg(t.id);
            console.log("当前装备id：", t.id),
            1 == e.isSkin && n.default.instance.rolePlay_reset(t.id)
        }
    },
    ...
    t.prototype.quickSellForSaveData = function(t) {
        ...
        if (e && !(e.length <= 0)) {
            for (var o = 0,
            a = u.PlayerMgr.getInstance().geUserData().getOwnedEquipList(), r = 0; r < a.length; r++) for (var n = 0; n < a[r].length; n++) for (var l = 0; l < e.length; l++) if (a[r][n].quality == e[l]) {
                "D" == u.PlayerMgr.getInstance().getAbType() ? o += this.getEquipSellValue(a[r][n].id, a[r][n].type, a[r][n].IDCard, a[r][n]) : o += c.DataMgr.getInstance().getEquipStrengthenCfg(a[r][n].id, a[r][n].strengthenLv).sellPrice,
                u.PlayerMgr.getInstance().geUserData().abandonEquip(a[r][n]),
                n--;
                break
            }
    ...
    t.prototype.getEquipFightForId = function(t, e, o, a, i) {
        var n = null;
        if (i) n = i;
        else if (!e) for (var s = this.getOwmedEquipForEquipType(o), l = 0; l < s.length; l++) if (t == s[l].id && a == s[l].IDCard) {
            n = s[l];
            break
        }
        if (!n) {
        ...
        f = 0;
        if (d.atk) {
            var m, y = r.Utils.getTabelArr(d.atk);
        ...
        return d.hp && (f = d.hp, d.LvHp && (f += d.LvHp * p), g && g > 0 && (m = c.DataMgr.getInstance().getEquipStarCfg(n.id, g)).hp && (f += m.hp * g)),
        4 * (h[0] + h[1]) + f
    },
    t.prototype.getEquipSellValue = function(t, e, o, a) {
        var i;
        if (a) i = a;
        else for (var n = this.getOwmedEquipForEquipType(e), s = 0; s < n.length; s++) if (t == n[s].id && o == n[s].IDCard) {
            i = n[s];
            break
        }
        ...
        d = Math.floor(p % 10),
        h = 0;
        for (s = 0; s <= g; s++) h += s == g ? Number(u[s][1]) * d: 10 * Number(u[s][1]);
...
o.default = g,
function(t) {
    t[t.EnumNoShow = 1] = "EnumNoShow",
    t[t.EnumStrengthen = 2] = "EnumStrengthen",
    t[t.EnumSell = 3] = "EnumSell"
