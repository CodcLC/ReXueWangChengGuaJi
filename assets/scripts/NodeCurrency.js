...
d = function(t) {
    ...
    e.prototype.registerEvent = function() {
        n.EventMgr.getInstance().on(c.EventName.RefreshGoldNumAndShow, this, this.refreshGoldNumAndShow),
        n.EventMgr.getInstance().on(c.EventName.RefreshInGotNumAndShow, this, this.refreshInGotNumAndShow)
    },
    e.prototype.registerBtnEvent = function() {
        this.GoldBg.on(cc.Node.EventType.TOUCH_END,
        function() {
            s.UIMgr.getInstance().openUI(c.UIID.UIGeneralWindow, -1, c.GeneralWindowType.GoldWindow)
        }),
        this.InGotBg.on(cc.Node.EventType.TOUCH_END,
        function() {
    ...
    e.prototype.initView = function() {
        this.refreshGoldNumAndShow(),
        this.refreshInGotNumAndShow()
    },
    ...
    e.prototype.onDestroy = function() {
        n.EventMgr.getInstance().off(c.EventName.RefreshGoldNumAndShow, this, this.refreshGoldNumAndShow),
        n.EventMgr.getInstance().off(c.EventName.RefreshInGotNumAndShow, this, this.refreshInGotNumAndShow)
    },
    r([g({
        type: cc.Node,
        tooltip: "金币点击框"
    })], e.prototype, "GoldBg", void 0),
    r([g({
        type: cc.Node,
        tooltip: "元宝点击框"
    })], e.prototype, "InGotBg", void 0),
    r([g({
        type: cc.Label,
        tooltip: "金币标签"
    })], e.prototype, "GoldNum", void 0),
    r([g({
        type: cc.Label,
        tooltip: "元宝标签"
    })], e.prototype, "InGotNum", void 0),
    r([p], e)
} (cc.Component);
o.default = d