...
p = function(t) {
    ...
    e.prototype.onLoad = function() {
        var t = this;
        this.addEvent(s.BaseEventName.blocktouch, this.onBlockTouch),
    ...
    r([u(cc.Node)], e.prototype, "touchNode", void 0),
    r([u({
        displayName: "是否需要点击特效"
    })], e.prototype, "needEffect", void 0),
    r([l], e)
} (n.default);
o.default = p