...
var a = t("ResourceMgr"); (function(t) {
    t[t.defTickNum = 1] = "defTickNum",
    t[t.freeLottyNum = 2] = "freeLottyNum",
    t[t.colloctionTime = 3] = "colloctionTime",
    t[t.colloctionCanNext = 4] = "colloctionCanNext",
    t[t.colloctionRepet = 5] = "colloctionRepet"
...
var i = function() {
    ...
    t.prototype.preload = function(t) {
        var e = this;
        a.ResourceMgr.getInstance().loadRes("comconfig", "GameJsonCfg", cc.JsonAsset,
        function(o) {
            e.data = o.json,
            o.decRef(),
            a.ResourceMgr.getInstance().releaseBundle("comconfig"),
            t && t()
        })
    },
