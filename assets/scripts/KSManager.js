...
var a = function() {
            ...
            success: function(e) {
                ...
                ks.authorize({
                    ...
                    success: function() {
                        ks.getUserInfo({
                            success: function(e) {
                                e ? t(e.userName, e.userHead) : t(null, null),
                                console.log("head" + JSON.stringify(e.userHead))
                            },
                            fail: function(e) {
                                t(null, null),
                    ...
                    fail: function(e) {
                        t(null, null),
                        console.log("授权获取用户信息失败: " + JSON.stringify(e))
                    },
                    complete: function() {}
                })
            },
    ...
    t.prototype.addShortcut = function(t, e) {
        ks.saveAPKShortcut(function(t) { - 10005 === t.code ? e("暂不支持该功能") : 1 === t.code ? e("桌面图标添加成功") : e("暂不支持该功能")
        })
    },
    ...
    t.prototype.showVideoAd = function(t, e, o) {
        ...
        r = function(t) {
            ...
            a.rewardedVideoAd.offError(i),
            a.rewardedVideoAd.offClose(r)
        };
        this.rewardedVideoAd.onError(i),
        this.rewardedVideoAd.onClose(r),
        this.rewardedVideoAd.show().then(function() {
            return console.log("激励视频 广告显示")
        })
    },
    t.prototype.otherFun = function() {},
