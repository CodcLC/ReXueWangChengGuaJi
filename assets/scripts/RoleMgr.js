...
p = function() {
    function t() {
        this.bundleSkin = "showEquipImg",
        this.defaultClothes = "cq_js0",
        this.defaultWeapon = "weapon_00",
        this.curFightNumForPlayer = 0,
        this.playerPro_copy = null,
        this.playerPro_copy1 = null,
        this.playerPro = null,
        this.playerPro_equip = null,
        this.playerPro_suit = null,
        this.playerPro_salutation = null,
        this.playerPro_pet = null,
        this.playerPro_skillBook = null,
        this.playerPro_fetter = null,
        this.specialFetterArr = []
    }
    ...
    t.prototype.getPlayerFightNum = function() {
        ...
        return this.curFightNumForPlayer = t,
        t
    },
    t.prototype.getEquipFightNum = function() {
        for (var t = 0,
        e = s.default.getInstance().getWearEquipList(), o = 0; o < e.length; o++) {
    ...
    t.prototype.getSuitFightNum = function() {
        for (var t = 0,
        e = s.default.getInstance().getAllSuitList(), o = 0; o < e.length; o++) if (! (e[o].count <= 0)) {
            ...
            for (var e = u.PlayerMgr.getInstance().geUserData().getWearEquipList(), o = 0; o < e.length; o++) {
                ...
                if ("D" == i || "B" == i) {
                    ...
                    if (r.LvHp && (this.playerPro_equip.hp_total += r.hp + r.LvHp * e[o].strengthenLv), r.LvHp && (this.playerPro_equip.hp += r.hp + r.LvHp * e[o].strengthenLv), r.LvAtk) {
                        ...
                        this.playerPro_equip.attack_min += Number(s[0]) + Number(c[0]) * e[o].strengthenLv,
                        this.playerPro_equip.attack_max += Number(s[1]) + Number(c[1]) * e[o].strengthenLv
                    }
                    if (r.atkSpeed && (this.playerPro_equip.atkSpeed += r.atkSpeed), r.atkCrazyProb && (this.playerPro_equip.atkCrazyProb += r.atkCrazyProb), r.atkCrazyHurt && (this.playerPro_equip.atkCrazyHurt += r.atkCrazyHurt), r.dodgeHurtProb && (this.playerPro_equip.dodgeHurtProb += r.dodgeHurtProb), e[o].starLevel && e[o].starLevel > 0) {
                        ...
                        if (l.atk) {
                            ...
                            this.playerPro_equip.attack_min += Number(p[0]),
                            this.playerPro_equip.attack_max += Number(p[1])
                        }
                        l.atkSpeed && (this.playerPro_equip.atkSpeed += l.atkSpeed),
                        l.atkCrazyProb && (this.playerPro_equip.atkCrazyProb += l.atkCrazyProb),
                        l.atkCrazyHurt && (this.playerPro_equip.atkCrazyHurt += l.atkCrazyHurt),
                        l.dodgeHurtProb && (this.playerPro_equip.dodgeHurtProb += l.dodgeHurtProb)
                    }
                } else {
                    var g = n.DataMgr.getInstance().getEquipStrengthenCfg(e[o].id, e[o].strengthenLv);
                    g.hp && (this.playerPro_equip.hp_total += g.hp),
                    g.hp && (this.playerPro_equip.hp += g.hp),
                    g.atk && (s = a.Utils.getTabelArr(g.atk), this.playerPro_equip.attack_min += Number(s[0]), this.playerPro_equip.attack_max += Number(s[1])),
                    g.atkSpeed && (this.playerPro_equip.atkSpeed += g.atkSpeed),
                    g.atkCrazyProb && (this.playerPro_equip.atkCrazyProb += g.atkCrazyProb),
                    g.atkCrazyHurt && (this.playerPro_equip.atkCrazyHurt += g.atkCrazyHurt),
                    g.dodgeHurtProb && (this.playerPro_equip.dodgeHurtProb += g.dodgeHurtProb)
                }
            }
        }
    ...
    t.prototype.selectPro_suit = function(t, e) {
        ...
        switch (t) {
            ...
            case r.EnumObjectProp.AtkProp:
                this.playerPro_suit.attack_min += o.attack_min * (e / 100),
            this.playerPro_suit.attack_max += o.attack_max * (e / 100);
            break;
            case r.EnumObjectProp.HpProp:
                this.playerPro_suit.hp_total += o.hp_total * (e / 100),
        ...
        for (var e = n.DataMgr.getInstance().getSalutation(t), o = 1; o <= 2; o++) {
            ...
            if (i) switch (Number(i[0])) {
                ...
                case r.EnumObjectProp.AtkProp_value:
                    this.playerPro_salutation.attack_min += Number(i[1]),
                this.playerPro_salutation.attack_max += Number(i[1]);
                break;
                case r.EnumObjectProp.HpProp_value:
                    this.playerPro_salutation.hp_total += Number(i[1]),
                this.playerPro_salutation.hp += Number(i[1]);
                break;
                case r.EnumObjectProp.AtkSpeed:
        ...
        for (var e = this.getPlayerProNotPet(), o = n.DataMgr.getInstance().getPetsCfg(), i = 1; i <= 2; i++) {
            ...
            if (s) switch (Number(s[0])) {
                case r.EnumObjectProp.SkillProp:
                    break;
                case r.EnumObjectProp.AtkProp:
                    this.playerPro_pet.attack_min += e.attack_min * (Number(s[1]) / 100),
                this.playerPro_pet.attack_max += e.attack_max * (Number(s[1]) / 100);
                break;
                case r.EnumObjectProp.HpProp:
                    this.playerPro_pet.hp_total += e.hp_total * (Number(s[1]) / 100),
                this.playerPro_pet.hp += e.hp * (Number(s[1]) / 100);
                break;
                case r.EnumObjectProp.AtkProp_value:
                    this.playerPro_pet.attack_min += Number(s[1]),
                this.playerPro_pet.attack_max += Number(s[1]);
                break;
                case r.EnumObjectProp.HpProp_value:
                    this.playerPro_pet.hp_total += Number(s[1]),
                this.playerPro_pet.hp += Number(s[1]);
                break;
                case r.EnumObjectProp.AtkSpeed:
    ...
    t.prototype.selectPro_skillBook = function(t, e) {
        ...
        switch (t) {
            case r.EnumObjectProp.SkillProp:
                break;
            case r.EnumObjectProp.AtkProp:
                this.playerPro_skillBook.attack_min += o.attack_min * (e / 100),
            this.playerPro_skillBook.attack_max += o.attack_max * (e / 100);
            break;
            case r.EnumObjectProp.HpProp:
                this.playerPro_skillBook.hp_total += o.hp_total * (e / 100),
    ...
    t.prototype.getPropForAllFetter = function(t) {
        if (void 0 === t && (t = !1), !this.playerPro_fetter || t) {
            ...
            for (var e = l.default.getInstance().getFetterIdArr(), o = 0; o < e.length; o++) {
                ...
                } else this.addSpecialFetter(e[o]),
                this.refreshFetter(e[o].id, r)
            }
        }
    ...
    t.prototype.selectPro_fetter = function(t, e) {
        ...
        switch (t) {
            case r.EnumObjectProp.SkillProp:
                break;
            case r.EnumObjectProp.AtkProp:
                this.playerPro_fetter.attack_min += o.attack_min * (e / 100),
            this.playerPro_fetter.attack_max += o.attack_max * (e / 100);
            break;
            case r.EnumObjectProp.HpProp:
                this.playerPro_fetter.hp_total += o.hp_total * (e / 100),
    ...
    t.prototype.getSpecialFetterArr = function() {
        return this.specialFetterArr || (this.specialFetterArr = []),
        this.specialFetterArr
    },
    ...
    t.prototype.isExistFetterForFetterId = function(t) {
        if (!this.specialFetterArr) return this.specialFetterArr = [],
        !1;
        for (var e = 0; e < this.specialFetterArr.length; e++) if (t == this.specialFetterArr[e].id) return ! 0;
        return ! 1
    },
    ...
    t.prototype.refreshCurPlayerProp = function() {
        this.getPropForAllSkillBook(!0),
        this.getPropForAllFetter(!0),
        i.default.instance.refreshPropPlayer()
    },
