...
n = function() {
    function t() {
        this.addSkillAndHurtProp = 0,
        this.recoverHp_levelEnd_base = 0,
        this.recoverHp_levelEnd_add = 0,
        this.atkCount_base = 0,
        this.atkCount = 0,
        this.recoverHp_atkEnd_base = 0,
        this.alwaysAtkHurt_base = 0,
        this.alwaysAtkHurt = 0,
        this.firstAtkToCrazyProp_base = 0
    }
    return t.getInstance = function() {
        return null == this.instance && (this.instance = new t),
        this.instance
    },
    t.prototype.WarriorFetter = function() {},
    t.prototype.MasterFetter = function(t) {
    ...
    t.prototype.TaoistFetter = function() {},
    t.prototype.IntensifyFetter = function() {},
    t.prototype.SpeedFetter = function() {},
    t.prototype.WishFetter = function(t) {
    ...
    t.prototype.ShieldFetter = function() {},
    t.prototype.RuinFetter = function(t) {
    ...
    t.prototype.MagicArtsFetter = function() {},
    t.prototype.SummonFetter = function() {},
    t.prototype.SpecialFetter = function(t) {
