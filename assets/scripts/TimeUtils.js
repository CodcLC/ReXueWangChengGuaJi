...
var a = function() {
    ...
    t.BeforeTime = function(t) {
        ...
        return o <= 0 && (o = 1),
        Math.floor(o / 60 / 60 / 24) > 0 ? Math.floor(o / 60 / 60 / 24) + "天前": Math.floor(o / 60 / 60) > 0 ? Math.floor(o / 60 / 60) + "小时前": Math.floor(o / 60) > 0 ? Math.floor(o / 60) + "分钟前": Math.floor(o) + "秒前"
    },
    ...
    t.getSplaceTime = function(t, e) {
        var o = new Date;
        return o.getHours() >= t ? o.setHours(t + 24) : o.setHours(t),
        o.setMinutes(e),
        o.setSeconds(0),
        Number((o.getTime() / 1e3).toFixed(0))
    },
    t.isLastDayOfMonth = function(t) {
        ...
        return r == new Date(c.getTime() - 864e5).getDate() && (e = !0),
        e
    },
