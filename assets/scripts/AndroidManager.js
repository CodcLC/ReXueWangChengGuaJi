...
i = function() {
    ...
    t.prototype.showVideoAd = function(t, e, o) {
        ...
        jsb.reflection.callStaticMethod("org/cocos2dx/javascript/SdkManager", "showVideoAd", "(Ljava/lang/String;Ljava/lang/String;)V", "window.AndroidManager.videoCallback", t)
    },
    t.prototype.videoCallback = function(t) {
        console.log("----statu-----", t),
        1 == t ? this.callback() : this.errorcallback()
    },
