...
f = function(t) {
    ...
    e.prototype.initView = function() {
        ...
        for (var e = this.curEquipData.starLevel ? this.curEquipData.starLevel: 1, o = 0; o < this.NodeStar.childrenCount; o++) e > o ? cc.isValid(this.NodeStar.children[o]) && (this.NodeStar.children[o].getChildByName("SpStar").active = !0) : cc.isValid(this.NodeStar.children[o]) && (this.NodeStar.children[o].getChildByName("SpStar").active = !1);
        var a = u.DataMgr.getInstance().getEquipCfg(this.curEquipData.id);
        if (this.loadSpriteFrame(a.bundleQuality, a.iconQuality,
        function(e) {
            t.NodeEquip.getComponent(cc.Sprite).spriteFrame = e
        }), this.loadSpriteFrame(a.bundle, a.equipIcon,
        function(e) {
            ...
            cc.isValid(h) || ((h = cc.instantiate(this.LayoutNodeProp)).parent = this.LayoutProp, h.name = "LayoutProp1"),
            h.getChildByName("LabProp").getComponent(cc.RichText).string = "<color=#ffffff>攻击力：</c><color=#3bacf3>" + g + "~" + d + "</color>",
            this.loadPropChange(8, h)
        }
        if (a.LvHp) {
        ...
        a.atkSpeed && (f = this.curEquipData.starLevel ? u.DataMgr.getInstance().getEquipStarCfg(this.curEquipData.id, this.curEquipData.starLevel).atkSpeed: 0, this.addPropNode(3, a.atkSpeed + f)),
        a.atkCrazyProb && (f = this.curEquipData.starLevel ? u.DataMgr.getInstance().getEquipStarCfg(this.curEquipData.id, this.curEquipData.starLevel).atkCrazyProb: 0, this.addPropNode(4, a.atkCrazyProb + f)),
        a.atkCrazyHurt && (f = this.curEquipData.starLevel ? u.DataMgr.getInstance().getEquipStarCfg(this.curEquipData.id, this.curEquipData.starLevel).atkCrazyHurt: 0, this.addPropNode(5, a.atkCrazyHurt + f)),
        a.subHurt && (f = this.curEquipData.starLevel ? u.DataMgr.getInstance().getEquipStarCfg(this.curEquipData.id, this.curEquipData.starLevel).subHurt: 0, this.addPropNode(6, a.subHurt + f)),
        a.dodgeHurtProb && (f = this.curEquipData.starLevel ? u.DataMgr.getInstance().getEquipStarCfg(this.curEquipData.id, this.curEquipData.starLevel).dodgeHurtProb: 0, this.addPropNode(7, a.dodgeHurtProb + f))
    },
    e.prototype.addPropNode = function(t, e) {
        ...
        o.getChildByName("LabProp").getComponent(cc.RichText).string = "<color=#ffffff>" + a + "：</c><color=#3bacf3>" + e + p.default.getInstance().getPropPercent(t) + "</color>",
    ...
    r([h(cc.SpriteFrame)], e.prototype, "SpUp", void 0),
    r([h(cc.SpriteFrame)], e.prototype, "SpDown", void 0),
    r([h(cc.Node)], e.prototype, "BtnContinue", void 0),
    r([h(cc.Node)], e.prototype, "NodeEquip", void 0),
    r([h(cc.Node)], e.prototype, "NodeStar", void 0),
    r([h(cc.Label)], e.prototype, "LabName", void 0),
    r([h(cc.Node)], e.prototype, "LayoutProp", void 0),
    r([h({
        type: cc.Node,
        tooltip: "属性节点"
    })], e.prototype, "LayoutNodeProp", void 0),
    r([d], e)
} (n.default);
o.default = f