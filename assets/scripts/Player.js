...
function(t) {
    function e() {
        ...
        e.addUpSpeed = .7,
        e.generalSkillArr = ["gj1_1", "gj1_2", "gj1_3", "gj1_4", "gj1_5", "gj1_6"],
        e.generalSkillEffArr = ["dg1_1", "dg1_2", "dg1_3", "dg1_4", "dg1_5", "dg1_6"],
        e.isAtkState = !1,
        e.lowTimeScale = .2,
        e
    }
    return i(e, t),
    e.prototype.getNodePlayer = function() {
        return this.object
    },
    ...
    e.prototype.createObject = function(t, e, o, a, i, r, n, l, u, d) {
        ...
        void 0 === i && (i = !1),
        this.isPlayer = i,
        this.object = s.PoolMgr.getInstance().getNode("Player"),
        this.addUpSpeed = Number(g.DataMgr.getInstance().getParamsCfgForSingle(p.EnumParams.TrudgeSpeedValue).value) / 100,
        this.initObjectsState(),
        this.object ? this.loadObjectInfo(o, a, i, r, n, l, u, d) : (console.log("动态加载玩家"), c.ResourceMgr.getInstance().loadRes(t, e, cc.Prefab,
        function(t) {
            h.object = cc.instantiate(t),
            h.loadObjectInfo(o, a, i, r, n, l, u, d)
        }))
    },
    e.prototype.loadObjectInfo = function(t, e, o, a, i, r, n, s) {
        void 0 === o && (o = !1),
        this.skeleton = this.object.getChildByName("NodeSkeleton").getComponent(sp.Skeleton),
        ...
        this.refreshObject(),
        this.initSkillEffName(),
        this.initObject()
    },
    e.prototype.initSkillEffName = function() {
        var t = h.default.getInstance().getWearEquipData(1);
        if (t) for (var e = 0; e < this.generalSkillEffArr.length; e++) this.generalSkillEffArr[e] = "dg" + t.quality + "_" + (e + 1)
    },
    e.prototype.move = function(t, e) {
        if (cc.isValid(this.object)) if (t && cc.isValid(t.object) && t.objectState == S.EnumObjectState.Alive) {
            if (!this.isAtkState) if (cc.Vec2.distance(this.object.getPosition(), t.object.getPosition()) <= this.objectProperty.atkDis) this.isAtkState = !0,
            this.atkMonster(t, e);
            else {
                var o = this.object.x - t.object.x > 0 ? -1 : 1;
                "yd" != this.skeleton.animation && (n.AudioMgr.getInstance().playEffect(p.AudioId.BattleSound_Mobile), this.controlDir(t), this.playAnim("yd", !1)),
                this.object.x += this.objectProperty.speed * this.gameSpeedArr[this.curGameMultiply - 1] * o
            }
        } else e && e()
    },
        ...
        if (this.objectState == S.EnumObjectState.Alive) {
            if (t && cc.isValid(t.object) && t.objectState == S.EnumObjectState.Alive) {
                ...
                if (0 == r) {
                    ...
                    a = this.generalSkillArr[c],
                    i = this.generalSkillEffArr[c]
                } else a = s.skillAnimName,
                i = s.skillEffName;
                var h = t.isFullHp(),
                I = 0,
                M = [0, 0],
                ...
                D || this.isTriggerCrazyAtk(I) && (b = Math.ceil(b * (this.objectProperty.atkCrazyHurt / 100)), T = S.EnumLadleWordType.Atk_CrazyHurt),
                0 != r && (T = S.EnumLadleWordType.Atk_SkillHurt);
                var N = b,
                w = !1,
                B = [];
                if (0 != r) {
                    if (N = Math.ceil(N * s.damageValue / 100), 0 == s.damageType) {
                        ...
                        var A = !0;
                        for (c = 0; c < B.length; c++) if (B[c].objectProperty.hp > N) A = !1;
                        else if (3 == (P = g.DataMgr.getInstance().getMonsterProbCfg(B[c].objectId)).monsterType) {
                            A = !0,
                            w = !0;
                            break
                        }
                ...
                } else P = g.DataMgr.getInstance().getMonsterProbCfg(t.objectId),
                1 != u.default.instance.monsterCount && 3 != P.monsterType || t.objectProperty.hp <= N && (w = !0);
                this.playAnim(a, !1,
                function() {
                    if (i && "" != i) {
                        var e = cc.v2(0, 0);
                        if (0 != r) e = cc.v2(Math.abs(t.object.x - o.object.x), 0);
                        else {
                ...
                function() {
                    if (_.isHaveSpecialFetter()) {
                        ...
                        i = Math.ceil(N * a / 100);
                        o.addHp(i),
                        C.default.LabLoad(u.default.instance.node, l.Utils.posTransform(o.object, o.getHpBarNode().getPosition(), u.default.instance.node), "+" + i, C.default.height_ladleWord.height_type, void 0, v.default.getInstance().getColorForAtkType(S.EnumLadleWordType.Hp_Recover))
                    }
                    if (w) {
                        if (m.default.getInstance().setGameState(p.EnumGameState.GameBuffer), o.skeleton.timeScale = (o.timeScale_object * o.gameSpeedArr[o.curGameMultiply - 1] + (y.default.getInstance().isAdddUp ? o.addUpSpeed: 0)) * o.lowTimeScale, B.length > 0) for (var c = 0; c < B.length; c++) B[c].skeleton.timeScale = B[c].timeScale_object * o.gameSpeedArr[o.curGameMultiply - 1] * o.lowTimeScale;
                    ...
                    if (0 == r) t.subHp(T, N,
                    function() {
                        3 == g.DataMgr.getInstance().getMonsterProbCfg(t.objectId).monsterType && w && (console.log("所有怪物播放死亡动作"), u.default.instance.dieAllMonster(o.gameSpeedArr[o.curGameMultiply - 1])),
                        e && e()
                    });
                    ...
                    else if ( - 1 == s.damageType) o.addHp(N),
                    C.default.LabLoad(u.default.instance.node, l.Utils.posTransform(o.object, o.getHpBarNode().getPosition(), u.default.instance.node), "+" + N, C.default.height_ladleWord.height_type, void 0, v.default.getInstance().getColorForAtkType(S.EnumLadleWordType.Hp_Recover));
                    else {
                        var d = function(t) {
                            if (3 == g.DataMgr.getInstance().getMonsterProbCfg(B[t].objectId).monsterType && w) return B[t].subHp(T, N,
                            function() {
                                u.default.instance.dieAllMonster(o.gameSpeedArr[o.curGameMultiply - 1], o.lowTimeScale),
                                e && e()
                            }),
                            "break";
                            B[t].subHp(T, N,
                ...
                function() {
                    o.recycleNodeEff(),
                    o.isAtkState = !1,
                    w && (w = !1, o.skeleton.timeScale = o.timeScale_object * o.gameSpeedArr[o.curGameMultiply - 1] + (y.default.getInstance().isAdddUp ? o.addUpSpeed: 0), cc.isValid(t.object) && (t.skeleton.timeScale = t.timeScale_object * o.gameSpeedArr[o.curGameMultiply - 1]), u.default.instance.gameCamera.controlCameraZoom(.1, 1,
                    function() {
    ...
    e.prototype.moveAnim = function(t, e) {
        ...
        this.object.scaleX = o ? 1 : -1,
        this.object.getChildByName("SpHpBarBg").scaleX = o ? this.scale_hpBar: -this.scale_hpBar;
        var a = o ? -200 : 200,
    ...
    e.prototype.playAnim = function(t, e, o, a, i) {
        void 0 === e && (e = !1),
        this.skeleton && this.skeleton.findAnimation(t) && (this.skeleton.setAnimation(0, t, e), this.skeleton.timeScale = this.timeScale_object * this.gameSpeedArr[this.curGameMultiply - 1] + (y.default.getInstance().isAdddUp ? this.addUpSpeed: 0), this.skeleton.setEventListener(function(t, e) {
    ...
    e.prototype.controlDir = function(t) {
        ...
        this.object.scaleX = e ? this.scale_object: -this.scale_object,
        this.object.getChildByName("SpHpBarBg").scaleX = e ? this.scale_hpBar: -this.scale_hpBar
    },
    e.prototype.subHp = function(t, e, o, a) {
        var i = this;
        if (this.objectState == S.EnumObjectState.Alive && !this.isTriggerDodgeHurt()) {
            var r = Math.ceil(e); (r -= Math.ceil(r * (this.objectProperty.subHurt / 100))) <= 0 && (r = 1),
            this.objectProperty.hp -= r,
            this.refreshObject(),
            t == S.EnumLadleWordType.Atk_CrazyHurt ? (C.default.LabLoad(u.default.instance.node, l.Utils.posTransform(this.object, this.getHpBarNode().getPosition(), u.default.instance.node), "暴击", C.default.height_ladleWord.height_type, void 0, v.default.getInstance().getColorForAtkType(S.EnumLadleWordType.Atk_CrazyName)), C.default.LabLoad(u.default.instance.node, l.Utils.posTransform(this.object, this.getHpBarNode().getPosition(), u.default.instance.node), "-" + r, C.default.height_ladleWord.height_number, void 0, v.default.getInstance().getColorForAtkType(t))) : C.default.LabLoad(u.default.instance.node, l.Utils.posTransform(this.object, this.getHpBarNode().getPosition(), u.default.instance.node), "-" + r, C.default.height_ladleWord.height_number, void 0, v.default.getInstance().getColorForAtkType(t)),
            this.objectProperty.hp <= 0 ? (this.setDieState(), this.object.getChildByName("SpHpBarBg").active = !1, n.AudioMgr.getInstance().playEffect(p.AudioId.BattleSound_Die), this.playAnim("sw", !1, void 0, void 0,
            function() {
                i.setDie(),
                u.default.instance.overGameFail()
            }), o && o()) : a && a()
        }
    },
