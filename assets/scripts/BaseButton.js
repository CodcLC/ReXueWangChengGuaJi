...
u = function(t) {
    function e() {
        ...
        return e.invertTime = 1,
        e.touched = !1,
        e.touchmil = 0,
        e
    }
    return i(e, t),
    e.prototype._onTouchBegan = function(e) {
    ...
    e.prototype._onTouchEnded = function(e) {
        if (this.interactable && this.enabledInHierarchy) {
            if (this.touched) return this.node.pauseSystemEvents(!0),
            void this._resetState();
            n.AudioMgr.getInstance().playAudioButtonClicked(),
            this.touched = !0,
            this.touchmil = 0,
    ...
    e.prototype.update = function(e) {
        ...
        this.touched && (this.touchmil = this.touchmil + e, this.touchmil > this.invertTime && (this.touchmil = 0, this.touched = !1, this.node.resumeSystemEvents(!0)))
    },
    ...
    r([l], e.prototype, "invertTime", void 0),
    r([c], e)
} (cc.Button);
o.BaseButton = u