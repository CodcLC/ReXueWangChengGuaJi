    ...
    return t.LabLoad = function(t, e, o, r, n, s, c) {
        ...
        if (void 0 === r && (r = 60), cc.isValid(t)) {
            ...
            if (u) {
                u.parent = t,
                u.opacity = 255,
                e && u.setPosition(cc.v2(e.x, e.y + r));
                var p = u.getChildByName("labStr");
                o && (p.getComponent(cc.Label).string = o),
                n && (p.getComponent(cc.Label).fontSize = n),
                s && (p.color = s),
                this.LadEff(u),
                c && c()
            } else console.log("动态加载"),
            i.ResourceMgr.getInstance().loadRes("prefabs", "widget/LabLadleWord", cc.Prefab,
            function(a) { (u = cc.instantiate(a)).parent = t,
                u.opacity = 255,
                e && u.setPosition(e);
                var i = u.getChildByName("labStr");
                o && (i.getComponent(cc.Label).string = o),
                n && (i.getComponent(cc.Label).fontSize = n),
                s && (i.color = s),
                l.LadEff(u),
                c && c()
            })
