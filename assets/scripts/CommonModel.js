...
l = function() {
    ...
    t.prototype.initCommon = function(t) {
        i.UIMgr.getInstance().addUICnf(n.ComUICF),
        a.AudioMgr.getInstance().addAdConf(n.ComAudioCF),
        s.ComDataMgr.getInstance().preload(function() {
    ...
    t.prototype.addReward = function(t, e, o) {
        void 0 === o && (o = !0),
        o && c.ComPlayerMgr.getInstance().addCollection(t, e)
    },
    t
} ();
o.CommonModel = l