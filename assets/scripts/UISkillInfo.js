...
y = function(t) {
    ...
    e.prototype.start = function() {
        ...
        c.default.instance.controlObjectsAnim(!0),
        this.initData(),
        this.initView(),
        this.guideShow()
    },
    e.prototype.guideShow = function() {
        ...
        if (1 == t.getCurSec() && 1 == t.getEnterFirstSecCount()) {
            ...
            if (!e.getGuideEnd()) {
                ...
                if (o == 9 + e.putGuideNum)(a = new d.GuildCfg).distNode = this.NodeGuide,
                a.tipstring = "部分技能<color=#fce445>升至2星</color>后，可获得<color=#fce445>额外技能效果</color>噢",
                a.handIndex = cc.v2(200, -200),
                this.openUICallBack(l.UIID.UIGuide,
                function() {
                    e.addCurrentId()
                },
                a);
                else if (o == 10 + e.putGuideNum) {
                    var a; (a = new d.GuildCfg).distNode = this.BtnClose,
                    this.openUICallBack(l.UIID.UIGuide,
                    function() {
                        e.addCurrentId()
                    },
    ...
    e.prototype.registerBtnEvent = function() {
        ...
        function() {
            t.closeView(),
            c.default.instance.controlObjectsAnim(!1)
        }),
    ...
    e.prototype.initSkillInfo = function() {
        var t = this;
        this.loadSpriteFrame(this.curSkillData.bundle, this.curSkillData.skillIcon,
        function(e) {
            t.SpSkillIcon.spriteFrame = e
        }),
        this.LabSkillName.string = this.curSkillData.skillName;
        var e = ""; - 1 == this.curSkillData.damageType ? e = "<color=#1425ff>" + this.curSkillData.skillWeight + "%</color>概率使<color = #d000dd>玩家</color>恢复<color = #f60a0a>" + this.curSkillData.damageValue + "%</color>血量": 0 == this.curSkillData.damageType ? e = "<color=#1425ff>" + this.curSkillData.skillWeight + "%</color>概率对<color = #d000dd>前方单体</color>目标造成<color = #f60a0a>" + this.curSkillData.damageValue + "%</color>伤害": 1 == this.curSkillData.damageType ? e = "<color=#1425ff>" + this.curSkillData.skillWeight + "%</color>概率对<color = #d000dd>前方敌人</color>目标造成<color = #f60a0a>" + this.curSkillData.damageValue + "%</color>伤害": 1 == this.curSkillData.damageType && (e = "<color=#1425ff>" + this.curSkillData.skillWeight + "%</color>概率对<color = #d000dd>全体敌人</color>目标造成<color = #f60a0a>" + this.curSkillData.damageValue + "%</color>伤害"),
        this.LabSkillDec.string = e
    },
    ...
    r([m(cc.Node)], e.prototype, "NodePlayer", void 0),
    r([m(cc.Node)], e.prototype, "Player", void 0),
    r([m(cc.Node)], e.prototype, "NodeGuide", void 0),
    r([m(cc.Node)], e.prototype, "BtnClose", void 0),
    r([m(cc.Sprite)], e.prototype, "SpSkillIcon", void 0),
    r([m(cc.Label)], e.prototype, "LabSkillName", void 0),
    r([m(cc.RichText)], e.prototype, "LabSkillDec", void 0),
    r([f], e)
} (n.default);
o.default = y