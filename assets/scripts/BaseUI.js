...
h = cc._decorator,
f = h.ccclass,
m = h.property; (function(t) {
    t[t.None = 0] = "None",
    t[t.Pop = 1] = "Pop"
})(n = o.OpenAin || (o.OpenAin = {})),
cc.Enum(n);
var y = function(t) {
    function e() {
        var e = null !== t && t.apply(this, arguments) || this;
        return e.cache = !1,
        e.openAniType = n.None,
        e.goldLable = null,
        e.uid = -1,
        e.resArray = [],
        e.eventList = [],
    ...
    e.prototype.openAni = function() {
        ...
        if (this.openAniType == n.Pop) {
            ...
            if (o) {
                ...
                p.TweenMgr.getInstance().popOpenAin(i,
                function() {
    ...
    e.prototype.closeAni = function(t) {
        if (this.openAniType == n.None) t();
        else if (this.openAniType == n.Pop) {
            var e = this.node.getChildByName("bg");
            ...
            if (o) {
                ...
                p.TweenMgr.getInstance().popCloseAin(a,
                function() {
                    t()
                })
            } else t()
    ...
    e.prototype.closeUI = function(t, e, o, a, i) {
        var r = this;
        if (this.eventList && this.eventList.length > 0) for (var n = 0; n < this.eventList.length; n++) this.eventList[n].forEach(function(t, e) {
    ...
    e.prototype.closeNotAni = function(t, e, o, a, i) {
        this.openAniType = n.None,
        this.closeUI(t, e, o, a, i)
    },
    e.prototype.loadSpriteFrame = function() {
        ...
        r = !0,
        n = e.saveKey;
        u.ResourceMgr.getInstance().loadSpriteframe(o, a,
        function(e) {
            r && t.addRes(o, a, cc.SpriteFrame),
            t.isclose || i(e)
        },
        r, e.cacheTme, n)
    },
    e.prototype.loadRemoteSpriteFrame = function(t, e, o, a) {
        ...
        void 0 === o && (o = !0),
        void 0 === a && (a = 10),
        u.ResourceMgr.getInstance().loadRemoteSpriteFrame(t,
        function(a) {
    ...
    e.prototype.loadPrefab = function(t, e, o, a, i) {
        ...
        void 0 === a && (a = !0),
        void 0 === i && (i = 10),
        u.ResourceMgr.getInstance().loadRes(t, e, cc.Prefab,
        function(i) {
    ...
    e.prototype.loadTexture2D = function(t, e, o, a, i) {
        ...
        void 0 === a && (a = !0),
        void 0 === i && (i = 10),
        u.ResourceMgr.getInstance().loadRes(t, e, cc.Texture2D,
        function(i) {
    ...
    e.prototype.loadResFromBundle = function() {
        ...
        r = !0,
        n = e.type;
        u.ResourceMgr.getInstance().loadRes(o, a, n,
        function(e) {
            r && t.addRes(o, a, n),
            t.isclose || i(e)
        },
    ...
    e.prototype.loadFromRes = function(t, e, o, a) {
        var i = this;
        void 0 === a && (a = 10),
        u.ResourceMgr.getInstance().loadFromRes(t, e,
        function(a) {
            i.addRes("", t, e),
            i.isclose || o(a)
        })
    ...
    e.prototype.release = function() { ! this.cache && this.resArray && (l.ResCacheMgr.getInstance().refreshTime(this.resArray), this.resArray = [])
    },
    ...
    r([m({
        ...
        displayName: "打开动画"
    })], e.prototype, "openAniType", void 0),
    r([m({
        type: cc.Node,
        tooltip: "金币框"
    })], e.prototype, "goldNode", void 0),
    r([m({
        type: cc.Node,
        tooltip: "金币图"
    })], e.prototype, "goldIcon", void 0),
    r([m({
        type: cc.Label,
        tooltip: "金币label"
    })], e.prototype, "goldLable", void 0),
    r([f], e)
} (cc.Component);
o.default = y