...
d = t("KSManager"),
h = t("WebLinkManager"),
f = t("EditorManager"); (function(t) {
    t[t.ShenHe = 0] = "ShenHe",
    t[t.TrackVideoTime = 1] = "TrackVideoTime"
})(n = o.SwitchID || (o.SwitchID = {})),
o.SWCF = ((a = {})[n.ShenHe] = {
    appId: 1089,
    h5_wechat: 4,
    h5_bytedance: 1
...
i),
o.AdConfig = ((r = {})[s.Platform.ANDROID_233] = {
...
var m = function() {
    ...
    t.prototype.initSdk = function() {
        this.currentPaltform || (this.currentPaltform = new f.EditorManager),
    ...
    t.currentPlatform = s.Platform.BYTEDANCE,
    t
} ();
o.PlatformManager = m