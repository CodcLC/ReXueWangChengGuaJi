...
o.EventCF = o.TrackId = void 0,
function(t) {
    t[t.dau = 0] = "dau",
    t[t.guide1 = 1] = "guide1",
    t[t.guide1_1 = 2] = "guide1_1",
    t[t.guide2 = 3] = "guide2",
    t[t.guide2_1 = 4] = "guide2_1",
    t[t.guide2_2 = 5] = "guide2_2",
    t[t.guide3_1 = 6] = "guide3_1",
    t[t.guide3 = 7] = "guide3",
    t[t.guide4_1 = 8] = "guide4_1",
    t[t.guide4 = 9] = "guide4",
    t[t.guide5 = 10] = "guide5",
    t[t.guide6_1 = 11] = "guide6_1",
    t[t.guide6 = 12] = "guide6",
    t[t.guide7_1 = 13] = "guide7_1",
    t[t.guide7 = 14] = "guide7",
    t[t.guide8 = 15] = "guide8",
    t[t.guide9 = 16] = "guide9",
    t[t.guide10 = 17] = "guide10",
    t[t.guide11 = 18] = "guide11",
    t[t.guide12 = 19] = "guide12",
    t[t.guide13 = 20] = "guide13",
    t[t.guide14 = 21] = "guide14",
    t[t.guide15 = 22] = "guide15",
    t[t.guide16 = 23] = "guide16",
    t[t.guide17 = 24] = "guide17",
    t[t.guide18 = 25] = "guide18",
    t[t.guide19 = 26] = "guide19",
    t[t.guide20 = 27] = "guide20",
    t[t.guide21 = 28] = "guide21",
    t[t.guide22 = 29] = "guide22",
    t[t.click_signin = 30] = "click_signin",
    t[t.click_speed = 31] = "click_speed",
    t[t.click_skillswitch = 32] = "click_skillswitch",
    t[t.click_equip_quicksale = 33] = "click_equip_quicksale",
    t[t.click_equip_title = 34] = "click_equip_title",
    t[t.click_equip_unfix = 35] = "click_equip_unfix",
    t[t.click_equip_sale = 36] = "click_equip_sale",
    t[t.click_equip_slide = 37] = "click_equip_slide",
    t[t.click_getrefreshtime = 38] = "click_getrefreshtime",
    t[t.click_task = 39] = "click_task",
    t[t.click_mainlinetask = 40] = "click_mainlinetask",
    t[t.click_store = 41] = "click_store",
    t[t.click_buff_1 = 42] = "click_buff_1",
    t[t.click_buff_2 = 43] = "click_buff_2",
    t[t.click_buff_3 = 44] = "click_buff_3",
    t[t.click_refine = 45] = "click_refine",
    t[t.click_lock = 46] = "click_lock",
    t[t.onhookreward_click = 47] = "onhookreward_click",
    t[t.onhookreward_get = 48] = "onhookreward_get",
    t[t.onhookreward_getdouble = 49] = "onhookreward_getdouble",
    t[t.pet_appear = 50] = "pet_appear",
    t[t.pet_click = 51] = "pet_click",
    t[t.pet_get = 52] = "pet_get",
    t[t.pet_cancel = 53] = "pet_cancel",
    t[t.quickarrive_appear = 54] = "quickarrive_appear",
    t[t.quickarrive_get = 55] = "quickarrive_get",
    t[t.quickarrive_restart = 56] = "quickarrive_restart",
    t[t.getall_appear = 57] = "getall_appear",
    t[t.getall_get = 58] = "getall_get",
    t[t.chapter_start_X = 59] = "chapter_start_X",
    t[t.chapter_pass_X = 60] = "chapter_pass_X",
    t[t.chapter_fail_X = 61] = "chapter_fail_X",
    t[t.chapter_lv_X_Y = 62] = "chapter_lv_X_Y",
    t[t.chapter2_fetter_X = 63] = "chapter2_fetter_X",
    t[t.chapter2_skill2 = 64] = "chapter2_skill2",
    t[t.chapter2_skill3 = 65] = "chapter2_skill3",
    t[t.skill_upgrade_X_Y = 66] = "skill_upgrade_X_Y",
    t[t.equip_upgrade_X_Y = 67] = "equip_upgrade_X_Y",
    t[t.mainlinetask_X = 68] = "mainlinetask_X",
    t[t.refine_time_X = 69] = "refine_time_X",
    t[t.refine_equip_X = 70] = "refine_equip_X",
    t[t.refine_equip_lv_X = 71] = "refine_equip_lv_X",
    t[t.refine_equip_lv_time_X = 72] = "refine_equip_lv_time_X",
    t[t.box_time_X_Y = 73] = "box_time_X_Y",
    t[t.box2_chaptertime_X_Y = 74] = "box2_chaptertime_X_Y",
    t[t.box3_chaptertime_X_Y = 75] = "box3_chaptertime_X_Y",
    t[t.speed_X = 76] = "speed_X",
    t[t.quickarrive_X_Y = 77] = "quickarrive_X_Y",
    t[t.pet_X = 78] = "pet_X",
    t[t.store_time_X = 79] = "store_time_X",
    t[t.store_skill_X = 80] = "store_skill_X",
    t[t.store_quip_X = 81] = "store_quip_X",
    t[t.refine_equip_get_X = 82] = "refine_equip_get_X",
    t[t.strength = 83] = "strength",
    t[t.ingot = 84] = "ingot",
    t[t.coin = 85] = "coin",
    t[t.pet = 86] = "pet",
    t[t.quickarrive = 87] = "quickarrive",
    t[t.combatspeed = 88] = "combatspeed",
    t[t.getrefreshtime = 89] = "getrefreshtime",
    t[t.getallskill = 90] = "getallskill",
    t[t.doubleaward = 91] = "doubleaward",
    t[t.upgradeskill = 92] = "upgradeskill",
    t[t.skillbox = 93] = "skillbox",
    t[t.equipbox = 94] = "equipbox",
    t[t.equipvacancy = 95] = "equipvacancy",
    t[t.upgradeequip = 96] = "upgradeequip",
    t[t.signin = 97] = "signin",
    t[t.offlineaward = 98] = "offlineaward",
    t[t.task_doubleaward = 99] = "task_doubleaward",
    t[t.store_refresh = 100] = "store_refresh",
    t[t.store_getskill = 101] = "store_getskill",
    t[t.store_getequip = 102] = "store_getequip",
    t[t.refine_getequip = 103] = "refine_getequip",
    t[t.time_1 = 104] = "time_1",
    t[t.time_3 = 105] = "time_3",
    t[t.time_5 = 106] = "time_5",
    t[t.time_7 = 107] = "time_7",
    t[t.time_10 = 108] = "time_10",
    t[t.time_12 = 109] = "time_12",
    t[t.time_15 = 110] = "time_15",
    t[t.time_20 = 111] = "time_20"
} (i = o.TrackId || (o.TrackId = {})),
o.EventCF = ((a = {})[i.dau] = {
    eventKey: "dau",
    eventValue: "dau",
    info: "日活人数",
