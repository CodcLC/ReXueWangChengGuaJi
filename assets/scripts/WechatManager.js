...
i = function() {
    ...
    t.prototype.showBlockAd = function(t) {
        ...
        var e = this.customAdMap.get(t); (e = 1 === t ? this.customAdMap.get(1) : this.customAdMap.get(2)) && e.show()
    },
    t.prototype.hideBlockAd = function(t) {
        var e = this.customAdMap.get(t); (e = 1 === t ? this.customAdMap.get(1) : this.customAdMap.get(2)) && e.hide()
    },
    ...
    t.prototype.initSdk = function() {
        ...
        this.compareVersion(this.sdkVersion, "2.0.4") >= 0 && (this.BannerAd = wx.createBannerAd({
            ...
            t.BannerAd.style.top = a - t.BannerAdHight,
            t.BannerAd.style.left = (o - 320) / 2
        ...
        this.customAdMap.set(2, i),
        this.customAdMap.set(1, r)
    },
    ...
    t.prototype.showBanner = function(t, e) {
        null != this.BannerAd && (this.BannerAd.show().then(function() {}).
        catch(function() {}), e && e())
    },
